...
sml_Names.kTagCDPSPreference = _Python_sml_ClientInterface.cvar.sml_Names_kTagCDPSPreference
...
smlEVENT_CLI_EXTENSION_MESSAGE = _Python_sml_ClientInterface.smlEVENT_CLI_EXTENSION_MESSAGE
...
class Kernel(ClientErrors):
    ...
    __swig_setmethods__["m_SoarInstance"] = _Python_sml_ClientInterface.Kernel_m_SoarInstance_set
    __swig_getmethods__["m_SoarInstance"] = _Python_sml_ClientInterface.Kernel_m_SoarInstance_get
    if _newclass:m_SoarInstance = _swig_property(_Python_sml_ClientInterface.Kernel_m_SoarInstance_get, _Python_sml_ClientInterface.Kernel_m_SoarInstance_set)
...
class ClientTraceXML(ClientXML):
    ...
    def IsTagCDPSPreference(self): return _Python_sml_ClientInterface.ClientTraceXML_IsTagCDPSPreference(self)
...
class Soar_Instance(_object):
    ...
    def Get_Chunk_Name_Format(self): return _Python_sml_ClientInterface.Soar_Instance_Get_Chunk_Name_Format(self)
    def Set_Chunk_Name_Format(self, *args): return _Python_sml_ClientInterface.Soar_Instance_Set_Chunk_Name_Format(self, *args)
